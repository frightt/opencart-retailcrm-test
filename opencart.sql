...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 24 2025 г., 06:33
...
(1, 1, 'Саша 2 Ивановна 1', 'Берсони 3', '', 'Nowy Swiat, 41', '', '', '', 20, 0, '[]'),
(2, 2, 'Vadzim', 'Malchanau', '', '25-522, Poland, Kielce, Nowy Swiat, 48, ', '', 'Kielce', '25-522', 170, 2644, '[]'),
(3, 3, 'Vadzim', 'Malchanau', '', '25-522, Poland, Kielce, Nowy Swiat, 48, ', '', 'Kielce', '25-522', 170, 2644, '[]'),
(4, 4, 'Vadzim', 'Malchanau', '', '25-522, Poland, Kielce, Nowy Swiat, 48, ', '', 'Kielce', '25-522', 170, 2644, '[]');
...
(1, 'Default', '', 1, '2025-06-23 17:56:46', '2025-06-23 17:56:46');

-- --------------------------------------------------------

--
-- Структура таблицы `api_ip`
--
...
(1, 1, 0, 0, 'Саша 2', 'Берсони 3', 'test@gmail.com', '123', '', 'c6c751bc0bd4564e74812a42d6d27a63296bf2a0', 'WeX6uc19w', NULL, NULL, 0, 1, '{\"1\":66,\"2\":\"typaya i oret\"}', '', 1, 0, '', '', '2025-06-23 18:46:38'),
(2, 1, 0, 0, 'Vadzim', 'Malchanau', 'molchanovvdm@gmail.com', '792953772', '', '3ea0ad0f3ad74ad08ce9cdf1fc5cc6d4a1384030', 'sXGFtVFSE', NULL, NULL, 0, 2, '[]', '', 1, 0, '', '', '2025-06-23 23:09:28'),
(3, 1, 0, 0, 'Vadzim', 'Malchanau', 'molchanovvdm@gmail.com', '792953772', '', 'b1d9ed2927557aaebfed7036945f1588fb0e5ce7', 'OmXcgCuNj', NULL, NULL, 0, 3, '[]', '', 1, 0, '', '', '2025-06-23 23:09:30'),
(4, 1, 0, 0, 'Vadzim', 'Malchanau', 'molchanovvdm@gmail.com', '792953772', '', 'f9b767b83985b62b8c2c80ad440afe5889f576c0', 'rNOruruPX', NULL, NULL, 0, 4, '\"[]\"', '', 1, 0, '', '', '2025-06-23 23:09:32');
...
--
-- Структура таблицы `customer_affiliate`
--
...
--
-- Структура таблицы `customer_approval`
--
...
--
-- Структура таблицы `customer_search`
--
...
--
-- Структура таблицы `customer_wishlist`
--
...
--
-- Дамп данных таблицы `custom_field`
--
...
(46, 'module_retailcrm', 'catalog/model/checkout/order/addOrder/after', 'extension/module/retailcrm/order_create', 1, 0),
(47, 'module_retailcrm', 'catalog/model/checkout/order/addOrderHistory/after', 'extension/module/retailcrm/order_edit', 1, 0),
(48, 'module_retailcrm', 'catalog/model/account/customer/addCustomer/after', 'extension/module/retailcrm/customer_create', 1, 0),
(49, 'module_retailcrm', 'catalog/model/account/customer/editCustomer/after', 'extension/module/retailcrm/customer_edit', 1, 0),
(50, 'module_retailcrm', 'catalog/model/account/customer/editNewsletter/after', 'extension/module/retailcrm/customer_edit_newsletter', 1, 0),
(51, 'module_retailcrm', 'catalog/model/account/address/editAddress/after', 'extension/module/retailcrm/customer_edit', 1, 0),
(52, 'module_retailcrm', 'admin/model/customer/customer/editCustomer/after', 'extension/module/retailcrm/customer_edit', 1, 0);
...
--
-- Структура таблицы `extension_install`
--
...
--
-- Дамп данных таблицы `extension_install`
--

INSERT INTO `extension_install` (`extension_install_id`, `extension_download_id`, `filename`, `date_added`) VALUES
(1, 0, 'retailcrm-4.2.0.ocmod.zip', '2025-06-23 15:00:51');

-- --------------------------------------------------------

--
-- Структура таблицы `extension_path`
--
...
--
-- Структура таблицы `googleshopping_category`
--

CREATE TABLE `googleshopping_category` (
...
--
-- Структура таблицы `googleshopping_product`
--
...
--
-- Структура таблицы `googleshopping_product_status`
--

CREATE TABLE `googleshopping_product_status` (
...
--
-- Структура таблицы `googleshopping_product_target`
--

CREATE TABLE `googleshopping_product_target` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `googleshopping_target`
--

CREATE TABLE `googleshopping_target` (
  `advertise_google_target_id` int(11) UNSIGNED NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `order` (`order_id`, `invoice_no`, `invoice_prefix`, `store_id`, `store_name`, `store_url`, `customer_id`, `customer_group_id`, `firstname`, `lastname`, `email`, `telephone`, `fax`, `custom_field`, `payment_firstname`, `payment_lastname`, `payment_company`, `payment_address_1`, `payment_address_2`, `payment_city`, `payment_postcode`, `payment_country`, `payment_country_id`, `payment_zone`, `payment_zone_id`, `payment_address_format`, `payment_custom_field`, `payment_method`, `payment_code`, `shipping_firstname`, `shipping_lastname`, `shipping_company`, `shipping_address_1`, `shipping_address_2`, `shipping_city`, `shipping_postcode`, `shipping_country`, `shipping_country_id`, `shipping_zone`, `shipping_zone_id`, `shipping_address_format`, `shipping_custom_field`, `shipping_method`, `shipping_code`, `comment`, `total`, `order_status_id`, `affiliate_id`, `commission`, `marketing_id`, `tracking`, `language_id`, `currency_id`, `currency_code`, `currency_value`, `ip`, `forwarded_ip`, `user_agent`, `accept_language`, `date_added`, `date_modified`, `shipping_date`, `shipping_date_to`) VALUES
(1, 0, '', 0, 'Your Store', '', 1, 1, 'Саша', 'Берсони', 'test@gmail.com', '123', '', 'null', 'Саша 2', 'Берсони 3', '', 'Nowy Swiat, 41', '', '', '', 'Belarus', 20, '', 0, '', '', 'Cash On Delivery', 'cod', 'Саша', 'Берсони', '', 'Nowy Swiat, 41', '', '', '', 'Belarus', 20, '', 0, '', '', 'Flat Shipping Rate', 'flat.flat', 'Помогать не надо', '1800.0000', 1, 0, '0.0000', 0, 'Помогать не надо', 1, 2, 'USD', '1.00000000', '', '', '', '', '2025-06-23 18:46:38', '2025-06-23 20:21:24', '2025-07-11 00:00:00', NULL),
(2, 0, 'INV-2025-00', 0, 'Your Store', 'http://opencart-retailcrm-test/', 4, 1, 'Vadzim', 'Malchanau', 'molchanovvdm@gmail.com', '792953772', '', '{\"1\":\"    \",\"2\":\"    \"}', 'Vadzim', 'Malchanau', '', '25-522, Poland, Kielce, Nowy Swiat, 48, ', '', 'Kielce', '25-522', 'Poland', 170, 'Warminsko-Mazurskie', 2644, '', '[]', 'Free Checkout', 'free_checkout', 'Vadzim', 'Malchanau', '', '25-522, Poland, Kielce, Nowy Swiat, 48,', '', 'Kielce', '25-522', 'Poland', 170, 'Warminsko-Mazurskie', 2644, '', '[]', 'Flat Shipping Rate', 'flat.flat', 'test', '106.0000', 1, 0, '0.0000', 0, 'test', 1, 2, 'USD', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', 'ru,ru-RU;q=0.9,en-US;q=0.8,en;q=0.7', '2025-06-23 19:26:04', '2025-06-23 23:09:34', '0000-00-00 00:00:00', NULL),
(3, 0, 'INV-2025-00', 0, 'Your Store', 'http://opencart-retailcrm-test/', 3, 1, 'Vadzim', 'Malchanau', 'molchanovvdm@gmail.com', '792953772', '', '{\"1\":\"    \",\"2\":\"    \"}', 'Vadzim', 'Malchanau', '', '25-522, Poland, Kielce, Nowy Swiat, 48, ', '', 'Kielce', '25-522', 'Poland', 170, 'Warminsko-Mazurskie', 2644, '', '[]', 'Free Checkout', 'free_checkout', 'Vadzim', 'Malchanau', '', '25-522, Poland, Kielce, Nowy Swiat, 411,', '', 'Kielce', '25-522', 'Poland', 170, 'Warminsko-Mazurskie', 2644, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', '106.0000', 1, 0, '0.0000', 0, '', 1, 2, 'USD', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', 'ru,ru-RU;q=0.9,en-US;q=0.8,en;q=0.7', '2025-06-23 19:36:31', '2025-06-23 23:09:32', '0000-00-00 00:00:00', NULL),
(4, 0, 'INV-2025-00', 0, 'Your Store', 'http://opencart-retailcrm-test/', 4, 1, 'Vadzim', 'Malchanau', 'molchanovvdm@gmail.com', '792953772', '', '\"\"', 'Vadzim', 'Malchanau', '', '25-522, Poland, Kielce, Nowy Swiat, 48, ', '', 'Kielce', '25-522', 'Poland', 170, 'Warminsko-Mazurskie', 2644, '', '[]', 'Free Checkout', 'free_checkout', 'Vadzim', 'Malchanau', '', 'улица Новы Свят', '', 'Kielce', '25-522', 'Belarus', 20, 'Kujawsko-Pomorskie', 2632, '', '[]', 'Flat Shipping Rate', 'flat.flat', 'test n3', '106.0000', 1, 0, '0.0000', 0, 'test n3', 1, 2, 'USD', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', 'ru,ru-RU;q=0.9,en-US;q=0.8,en;q=0.7', '2025-06-23 20:08:21', '2025-06-23 23:10:03', '0000-00-00 00:00:00', NULL),
(5, 0, 'INV-2025-00', 0, 'Your Store', 'http://opencart-retailcrm-test/', 0, 1, 'Vadzim', 'Malchanau', 'molchanovvdm@gmail.com', '792953772', '', '{\"1\":\"  \",\"2\":\"  \"}', 'Vadzim', 'Malchanau', '', 'Nowy Swiat, 11111', '', 'Kielce', '25-522', 'Poland', 170, 'Kujawsko-Pomorskie', 2632, '', '[]', 'Cash On Delivery', 'cod', 'Vadzim', 'Malchanau', '', 'Nowy Swiat, 11111', '', 'Kielce', '25-522', 'Poland', 170, 'Kujawsko-Pomorskie', 2632, '', '[]', 'Flat Shipping Rate', 'flat.flat', 'test4', '106.0000', 1, 0, '0.0000', 0, '', 1, 2, 'USD', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', 'ru,ru-RU;q=0.9,en-US;q=0.8,en;q=0.7', '2025-06-23 20:21:01', '2025-06-23 20:21:05', NULL, NULL),
(6, 0, 'INV-2025-00', 0, 'Your Store', 'http://opencart-retailcrm-test/', 0, 1, 'Vadzim', 'Malchanau', 'molchanovvdm@gmail.com', '792953772', '', '{\"1\":\"  \",\"2\":\"  \",\"need_call\":0}', 'Vadzim', 'Malchanau', '', 'Nowy Swiat, 11111', '', 'Kielce', '25-522', 'Poland', 170, 'Kujawsko-Pomorskie', 2632, '', '[]', 'Cash On Delivery', 'cod', 'Vadzim', 'Malchanau', '', 'Nowy Swiat, 11111', '', 'Kielce', '25-522', 'Poland', 170, 'Kujawsko-Pomorskie', 2632, '', '[]', 'Flat Shipping Rate', 'flat.flat', 'test12', '106.0000', 1, 0, '0.0000', 0, '', 1, 2, 'USD', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', 'ru,ru-RU;q=0.9,en-US;q=0.8,en;q=0.7', '2025-06-23 20:59:00', '2025-06-23 20:59:04', NULL, NULL),
(7, 0, 'INV-2025-00', 0, 'Your Store', 'http://opencart-retailcrm-test/', 0, 1, 'Vadzim', 'Malchanau', 'molchanovvdm@gmail.com', '792953772', '', '{\"1\":\"  \",\"2\":\"  \",\"need_call\":0}', 'Vadzim', 'Malchanau', '', 'Nowy Swiat, 11111', '', 'Kielce', '25-522', 'Poland', 170, 'Kujawsko-Pomorskie', 2632, '', '[]', 'Cash On Delivery', 'cod', 'Vadzim', 'Malchanau', '', 'Nowy Swiat, 11111', '', 'Kielce', '25-522', 'Poland', 170, 'Kujawsko-Pomorskie', 2632, '', '[]', 'Flat Shipping Rate', 'flat.flat', 'sdfsdfsdfsfd', '106.0000', 1, 0, '0.0000', 0, '', 1, 2, 'USD', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', 'ru,ru-RU;q=0.9,en-US;q=0.8,en;q=0.7', '2025-06-23 21:17:15', '2025-06-23 21:17:19', NULL, NULL),
(8, 0, 'INV-2025-00', 0, 'Your Store', 'http://opencart-retailcrm-test/', 0, 1, 'Vadzim', 'Malchanau', 'molchanovvdm@gmail.com', '792953772', '', '{\"1\":\"  \",\"2\":\"  \",\"need_call\":0}', 'Vadzim', 'Malchanau', '', 'Nowy Swiat, 11111', '', 'Kielce', '25-522', 'Poland', 170, 'Kujawsko-Pomorskie', 2632, '', '[]', 'Cash On Delivery', 'cod', 'Vadzim', 'Malchanau', '', 'Nowy Swiat, 11111', '', 'Kielce', '25-522', 'Poland', 170, 'Kujawsko-Pomorskie', 2632, '', '[]', 'Flat Shipping Rate', 'flat.flat', 'test123', '106.0000', 1, 0, '0.0000', 0, '', 1, 2, 'USD', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', 'ru,ru-RU;q=0.9,en-US;q=0.8,en;q=0.7', '2025-06-23 21:22:00', '2025-06-23 21:22:04', NULL, NULL),
(9, 0, 'INV-2025-00', 0, 'Your Store', 'http://opencart-retailcrm-test/', 0, 1, 'Vadzim', 'Malchanau', 'molchanovvdm@gmail.com', '792953772', '', '{\"1\":\"  \",\"2\":\"  \",\"need_call\":0}', 'Vadzim', 'Malchanau', '', 'Nowy Swiat, 11111', '', 'Kielce', '25-522', 'Poland', 170, 'Kujawsko-Pomorskie', 2632, '', '[]', 'Cash On Delivery', 'cod', 'Vadzim', 'Malchanau', '', 'Nowy Swiat, 11111', '', 'Kielce', '25-522', 'Poland', 170, 'Kujawsko-Pomorskie', 2632, '', '[]', 'Flat Shipping Rate', 'flat.flat', 'ываываываыва', '106.0000', 1, 0, '0.0000', 0, '', 1, 2, 'USD', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', 'ru,ru-RU;q=0.9,en-US;q=0.8,en;q=0.7', '2025-06-23 21:26:22', '2025-06-23 21:26:37', NULL, NULL),
(10, 0, 'INV-2025-00', 0, 'Your Store', 'http://opencart-retailcrm-test/', 0, 1, 'Vadzim', 'Malchanau', 'molchanovvdm@gmail.com', '792953772', '', '{\"1\":\"  \",\"2\":\"  \",\"need_call\":0}', 'Vadzim', 'Malchanau', '', 'Nowy Swiat, 11111', '', 'Kielce', '25-522', 'Poland', 170, 'Kujawsko-Pomorskie', 2632, '', '[]', 'Cash On Delivery', 'cod', 'Vadzim', 'Malchanau', '', 'Nowy Swiat, 11111', '', 'Kielce', '25-522', 'Poland', 170, 'Kujawsko-Pomorskie', 2632, '', '[]', 'Flat Shipping Rate', 'flat.flat', '123123123123123', '106.0000', 1, 0, '0.0000', 0, '', 1, 2, 'USD', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', 'ru,ru-RU;q=0.9,en-US;q=0.8,en;q=0.7', '2025-06-23 21:29:37', '2025-06-23 21:29:41', NULL, NULL),
(11, 0, 'INV-2025-00', 0, 'Your Store', 'http://opencart-retailcrm-test/', 0, 1, 'Vadzim', 'Malchanau', 'molchanovvdm@gmail.com', '792953772', '', '{\"1\":\"  \",\"2\":\"  \",\"need_call\":0}', 'Vadzim', 'Malchanau', '', 'Nowy Swiat, 11111', '', 'Kielce', '25-522', 'Poland', 170, 'Kujawsko-Pomorskie', 2632, '', '[]', 'Cash On Delivery', 'cod', 'Vadzim', 'Malchanau', '', 'Nowy Swiat, 11111', '', 'Kielce', '25-522', 'Poland', 170, 'Kujawsko-Pomorskie', 2632, '', '[]', 'Flat Shipping Rate', 'flat.flat', 'вапвпвапва', '106.0000', 1, 0, '0.0000', 0, '', 1, 2, 'USD', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', 'ru,ru-RU;q=0.9,en-US;q=0.8,en;q=0.7', '2025-06-23 21:33:17', '2025-06-23 21:33:20', NULL, NULL),
(12, 0, 'INV-2025-00', 0, 'Your Store', 'http://opencart-retailcrm-test/', 0, 1, 'Dima', 'Malchanau', 'fright.end@mail.ru', '80441487732', '', '{\"1\":\"  \",\"2\":\"  \"}', 'Dima', 'Malchanau', '', 'Nowy Swiat, 11111', '', 'Kielce', '25-522', 'Lithuania', 123, 'Kujawsko-Pomorskie', 2632, '', '[]', 'Cash On Delivery', 'cod', 'Dima', 'Malchanau', '', 'Nowy Swiat, 11111', '', 'Kielce', '25-522', 'Lithuania', 123, 'Kujawsko-Pomorskie', 2632, '', '[]', 'Flat Shipping Rate', 'flat.flat', 'pls', '106.0000', 1, 0, '0.0000', 0, '', 1, 2, 'USD', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', 'ru,ru-RU;q=0.9,en-US;q=0.8,en;q=0.7', '2025-06-23 21:41:29', '2025-06-23 21:41:33', NULL, NULL),
(13, 0, 'INV-2025-00', 0, 'Your Store', 'http://opencart-retailcrm-test/', 0, 1, 'Sasha', 'Test', 'test@mail.ru', '80441487732', '', '{\"1\":\"  \",\"2\":\"  \",\"delivery_datetime\":null,\"need_call\":0}', 'Sasha', 'Test', '', 'Pylimo g. 19 - 5, Vilnius 0141', '', 'Minsk', '', 'Belarus', 20, 'Minskaya', 342, '', '[]', 'Cash On Delivery', 'cod', 'Sasha', 'Test', '', 'Pylimo g. 19 - 5, Vilnius 0141', '', 'Minsk', '', 'Belarus', 20, 'Minskaya', 342, '', '[]', 'Flat Shipping Rate', 'flat.flat', 'Test comment', '106.0000', 1, 0, '0.0000', 0, '', 1, 2, 'USD', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', 'ru,ru-RU;q=0.9,en-US;q=0.8,en;q=0.7', '2025-06-24 03:17:02', '2025-06-24 03:17:06', NULL, NULL),
(14, 0, 'INV-2025-00', 0, 'Your Store', 'http://opencart-retailcrm-test/', 0, 1, 'Vadim', 'Malchanau', 'fright.end@mail.ru', '80441487732', '', '{\"1\":\"  \",\"2\":\"  \",\"delivery_datetime\":null,\"need_call\":0}', 'Vadim', 'Malchanau', '', 'Pylimo g. 19 - 5, Vilnius 0141', '', 'Minsk', '', 'Lithuania', 123, 'Siauliai', 1916, '', '[]', 'Cash On Delivery', 'cod', 'Vadim', 'Malchanau', '', 'Pylimo g. 19 - 5, Vilnius 0141', '', 'Minsk', '', 'Lithuania', 123, 'Siauliai', 1916, '', '[]', 'Flat Shipping Rate', 'flat.flat', 'xxxxxxx', '106.0000', 1, 0, '0.0000', 0, '', 1, 2, 'USD', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', 'ru,ru-RU;q=0.9,en-US;q=0.8,en;q=0.7', '2025-06-24 03:23:54', '2025-06-24 03:23:59', NULL, NULL),
(15, 0, 'INV-2025-00', 0, 'Your Store', 'http://opencart-retailcrm-test/', 0, 1, 'Vadim', 'Malchanau', 'fright.end@mail.ru', '80441487732', '', '{\"0\":\"  \",\"1\":\"  \",\"need_call\":0}', 'Vadim', 'Malchanau', '', 'Pylimo g. 19 - 5, Vilnius 0141', '', 'Minsk', '', 'Lithuania', 123, 'Siauliai', 1916, '', '[]', 'Cash On Delivery', 'cod', 'Vadim', 'Malchanau', '', 'Pylimo g. 19 - 5, Vilnius 0141', '', 'Minsk', '', 'Lithuania', 123, 'Siauliai', 1916, '', '[]', 'Flat Shipping Rate', 'flat.flat', 'test', '106.0000', 1, 0, '0.0000', 0, '', 1, 2, 'USD', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', 'ru,ru-RU;q=0.9,en-US;q=0.8,en;q=0.7', '2025-06-24 03:28:34', '2025-06-24 03:28:45', NULL, NULL);
...
(1, 1, 1, 0, '', '2025-06-23 16:11:12'),
(2, 1, 1, 0, '', '2025-06-23 16:16:19'),
(3, 1, 1, 0, '', '2025-06-23 16:18:51'),
(4, 1, 1, 0, '', '2025-06-23 16:20:51'),
(5, 1, 1, 0, '', '2025-06-23 16:25:30'),
(6, 1, 1, 0, '', '2025-06-23 16:32:07'),
(7, 1, 1, 0, '', '2025-06-23 16:35:41'),
(8, 1, 1, 0, '', '2025-06-23 16:42:15'),
(9, 1, 1, 0, '', '2025-06-23 17:08:46'),
(10, 1, 1, 0, '', '2025-06-23 17:09:32'),
(11, 1, 1, 0, '', '2025-06-23 17:21:24'),
(12, 2, 1, 0, '', '2025-06-23 19:26:09'),
(13, 3, 1, 0, '', '2025-06-23 19:36:35'),
(14, 4, 1, 0, '', '2025-06-23 20:08:25'),
(15, 4, 1, 0, '', '2025-06-23 20:09:30'),
(16, 3, 1, 0, '', '2025-06-23 20:09:32'),
(17, 2, 1, 0, '', '2025-06-23 20:09:34'),
(18, 4, 1, 0, '', '2025-06-23 20:10:03'),
(19, 5, 1, 0, '', '2025-06-23 20:21:05'),
(20, 6, 1, 0, '', '2025-06-23 20:59:04'),
(21, 7, 1, 0, '', '2025-06-23 21:17:19'),
(22, 8, 1, 0, '', '2025-06-23 21:22:04'),
(23, 9, 1, 0, '', '2025-06-23 21:26:37'),
(24, 10, 1, 0, '', '2025-06-23 21:29:41'),
(25, 11, 1, 0, '', '2025-06-23 21:33:20'),
(26, 12, 1, 0, '', '2025-06-23 21:41:33'),
(27, 13, 1, 0, '', '2025-06-24 03:17:06'),
(28, 14, 1, 0, '', '2025-06-24 03:23:59'),
(29, 15, 1, 0, '', '2025-06-24 03:28:45');
...
(12, 1, 0, '', '', 1, '1500.0000', '1500.0000', '0.0000', 0),
(18, 2, 40, 'iPhone', 'product 11', 1, '101.0000', '101.0000', '0.0000', 0),
(17, 3, 40, 'iPhone', 'product 11', 1, '101.0000', '101.0000', '0.0000', 0),
(19, 4, 40, 'iPhone', 'product 11', 1, '101.0000', '101.0000', '0.0000', 0),
(20, 5, 40, 'iPhone', 'product 11', 1, '101.0000', '101.0000', '0.0000', 0),
(21, 6, 40, 'iPhone', 'product 11', 1, '101.0000', '101.0000', '0.0000', 0),
(22, 7, 40, 'iPhone', 'product 11', 1, '101.0000', '101.0000', '0.0000', 0),
(23, 8, 40, 'iPhone', 'product 11', 1, '101.0000', '101.0000', '0.0000', 0),
(24, 9, 40, 'iPhone', 'product 11', 1, '101.0000', '101.0000', '0.0000', 0),
(25, 10, 40, 'iPhone', 'product 11', 1, '101.0000', '101.0000', '0.0000', 0),
(26, 11, 40, 'iPhone', 'product 11', 1, '101.0000', '101.0000', '0.0000', 0),
(27, 12, 40, 'iPhone', 'product 11', 1, '101.0000', '101.0000', '0.0000', 0),
(28, 13, 40, 'iPhone', 'product 11', 1, '101.0000', '101.0000', '0.0000', 0),
(29, 14, 40, 'iPhone', 'product 11', 1, '101.0000', '101.0000', '0.0000', 0),
(30, 15, 40, 'iPhone', 'product 11', 1, '101.0000', '101.0000', '0.0000', 0);
...
--
-- Структура таблицы `order_shipment`
--
...
(36, 1, 'total', 'Total', '1800.0000', 9),
(35, 1, 'shipping', 'Flat Shipping Rate', '300.0000', 3),
(34, 1, 'sub_total', 'Sum', '1500.0000', 0),
(54, 2, 'total', 'Total', '106.0000', 9),
(53, 2, 'shipping', 'Flat Shipping Rate', '5.0000', 3),
(52, 2, 'sub_total', 'Sum', '101.0000', 0),
(51, 3, 'total', 'Total', '106.0000', 9),
(50, 3, 'shipping', 'Flat Shipping Rate', '5.0000', 3),
(49, 3, 'sub_total', 'Sum', '101.0000', 0),
(57, 4, 'total', 'Total', '106.0000', 9),
(56, 4, 'shipping', 'Flat Shipping Rate', '5.0000', 3),
(55, 4, 'sub_total', 'Sum', '101.0000', 0),
(58, 5, 'sub_total', 'Sub-Total', '101.0000', 1),
(59, 5, 'shipping', 'Flat Shipping Rate', '5.0000', 3),
(60, 5, 'total', 'Total', '106.0000', 9),
(61, 6, 'sub_total', 'Sub-Total', '101.0000', 1),
(62, 6, 'shipping', 'Flat Shipping Rate', '5.0000', 3),
(63, 6, 'total', 'Total', '106.0000', 9),
(64, 7, 'sub_total', 'Sub-Total', '101.0000', 1),
(65, 7, 'shipping', 'Flat Shipping Rate', '5.0000', 3),
(66, 7, 'total', 'Total', '106.0000', 9),
(67, 8, 'sub_total', 'Sub-Total', '101.0000', 1),
(68, 8, 'shipping', 'Flat Shipping Rate', '5.0000', 3),
(69, 8, 'total', 'Total', '106.0000', 9),
(70, 9, 'sub_total', 'Sub-Total', '101.0000', 1),
(71, 9, 'shipping', 'Flat Shipping Rate', '5.0000', 3),
(72, 9, 'total', 'Total', '106.0000', 9),
(73, 10, 'sub_total', 'Sub-Total', '101.0000', 1),
(74, 10, 'shipping', 'Flat Shipping Rate', '5.0000', 3),
(75, 10, 'total', 'Total', '106.0000', 9),
(76, 11, 'sub_total', 'Sub-Total', '101.0000', 1),
(77, 11, 'shipping', 'Flat Shipping Rate', '5.0000', 3),
(78, 11, 'total', 'Total', '106.0000', 9),
(79, 12, 'sub_total', 'Sub-Total', '101.0000', 1),
(80, 12, 'shipping', 'Flat Shipping Rate', '5.0000', 3),
(81, 12, 'total', 'Total', '106.0000', 9),
(82, 13, 'sub_total', 'Sub-Total', '101.0000', 1),
(83, 13, 'shipping', 'Flat Shipping Rate', '5.0000', 3),
(84, 13, 'total', 'Total', '106.0000', 9),
(85, 14, 'sub_total', 'Sub-Total', '101.0000', 1),
(86, 14, 'shipping', 'Flat Shipping Rate', '5.0000', 3),
(87, 14, 'total', 'Total', '106.0000', 9),
(88, 15, 'sub_total', 'Sub-Total', '101.0000', 1),
(89, 15, 'shipping', 'Flat Shipping Rate', '5.0000', 3),
(90, 15, 'total', 'Total', '106.0000', 9);
...
(28, 'Product 1', '', '', '333', '', '', '', '', 939, 7, 'catalog/demo/htc_touch_hd_1.jpg', 5, 1, '100.0000', 200, 9, '2009-02-03', '146.40000000', 2, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 0, '2009-02-03 16:06:50', '2011-09-30 01:05:39'),
(29, 'Product 2', '', '', '444', '', '', '', '', 999, 6, 'catalog/demo/palm_treo_pro_1.jpg', 6, 1, '279.9900', 0, 9, '2009-02-03', '133.00000000', 2, '0.00000000', '0.00000000', '0.00000000', 3, 1, 1, 0, 1, 0, '2009-02-03 16:42:17', '2011-09-30 01:06:08'),
(30, 'Product 3', '', '', '123', '', '', '', '', 7, 6, 'catalog/demo/canon_eos_5d_1.jpg', 9, 1, '100.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 0, '2009-02-03 16:59:00', '2011-09-30 01:05:23'),
...
(40, 'product 11', '', '', '', '', '', '', '', 956, 5, 'catalog/demo/iphone_1.jpg', 8, 1, '101.0000', 0, 9, '2009-02-03', '10.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 2, '2009-02-03 21:07:12', '2011-09-30 01:06:53'),
...
--
-- Структура таблицы `recurring_description`
--
...
('042bf3b46714255c1a3fd9df6d', '[]', '2025-06-23 18:40:04'),
('08939e362606673a2e55555f55', '{\"api_id\":\"1\"}', '2025-06-23 19:40:30'),
('08e663e3db28166d4a976e2e48', '[]', '2025-06-23 17:18:51'),
('0b779acc09c20b6922ec795f4f', '{\"api_id\":\"1\"}', '2025-06-23 19:40:24'),
('0bdae34397547bb40b28dc0b46', '{\"api_id\":\"1\"}', '2025-06-23 18:50:44'),
('1153d532afa93c66d10dc8d805', '[]', '2025-06-23 18:20:02'),
('253c9857e5e229a0b0d174ba84', '[]', '2025-06-23 16:55:15'),
('2dc24cbcbdb40192f79e107291', '{\"api_id\":\"1\"}', '2025-06-23 18:49:55'),
('2eaff8df04c1f74d74f419c31a', '{\"api_id\":\"1\"}', '2025-06-23 16:47:43'),
('3d2c52829012b11dec93c823de', '{\"api_id\":\"1\"}', '2025-06-23 18:21:32'),
('3d8fdbb166b1397175e06cd6c3', '[]', '2025-06-23 21:09:34'),
('440f39dc718b8dcc67850a0f23', '{\"api_id\":\"1\"}', '2025-06-23 16:57:06'),
('506bf59bd552a2b2473ce8df52', '[]', '2025-06-23 18:08:46'),
('591e1e1dd981d081e0bd948eca', '[]', '2025-06-23 19:14:02'),
('595c8991a16ddfff4b67743d7f', '[]', '2025-06-23 17:16:00'),
('5e67af17d0580922a0da5a8680', '[]', '2025-06-23 17:32:07'),
('63359a00e40b485ed78b56a33f', '{\"api_id\":\"1\"}', '2025-06-23 17:03:14'),
('6539f70d935cf9b4c279b65ac8', '[]', '2025-06-23 18:38:49'),
('67d3662eb7a2a2730dd7eaa07b', '{\"api_id\":\"1\"}', '2025-06-23 17:26:36'),
('74e7fb44b7e86a4d97e73c40c4', '[]', '2025-06-23 17:35:41'),
('76c19929a415311b6895c56268', '{\"user_id\":\"1\",\"user_token\":\"NQnxLZzCbUPZBFBNWdgjFydRyFQwMhM9\",\"language\":\"en-gb\",\"currency\":\"USD\",\"account\":\"guest\",\"payment_address\":{\"firstname\":\"Vadim\",\"lastname\":\"Malchanau\",\"company\":\"\",\"address_1\":\"Pylimo g. 19 - 5, Vilnius 0141\",\"address_2\":\"\",\"postcode\":\"\",\"city\":\"Minsk\",\"country_id\":\"123\",\"zone_id\":\"1916\",\"country\":\"Lithuania\",\"iso_code_2\":\"LT\",\"iso_code_3\":\"LTU\",\"address_format\":\"\",\"custom_field\":[],\"zone\":\"Siauliai\",\"zone_code\":\"SI\"},\"shipping_address\":{\"firstname\":\"Vadim\",\"lastname\":\"Malchanau\",\"company\":\"\",\"address_1\":\"Pylimo g. 19 - 5, Vilnius 0141\",\"address_2\":\"\",\"postcode\":\"\",\"city\":\"Minsk\",\"country_id\":\"123\",\"zone_id\":\"1916\",\"country\":\"Lithuania\",\"iso_code_2\":\"LT\",\"iso_code_3\":\"LTU\",\"address_format\":\"\",\"zone\":\"Siauliai\",\"zone_code\":\"SI\",\"custom_field\":[]},\"custom_field\":{\"need_call\":0},\"my_delivery_fields\":{\"need_call\":0}}', '2025-06-24 04:28:48'),
('77c8f4383e4e137f05b43d90c7', '{\"api_id\":\"1\"}', '2025-06-23 18:21:36'),
('7ac09c8c1b119a3aee30ddba7a', '[]', '2025-06-23 18:21:24'),
('7b184bf870b9e0e447fbf185c8', '[]', '2025-06-23 18:38:12'),
('7e35a77bc70aaa0c476ab684bd', '{\"api_id\":\"1\"}', '2025-06-23 16:56:59'),
('7fd642fa70c1d2f3b44be755d8', '{\"api_id\":\"1\"}', '2025-06-23 16:47:34'),
('821ed97c95c3453d5bfbde1c40', '{\"api_id\":\"1\"}', '2025-06-23 17:35:51'),
('892ce27eb481de19b65bd40b7f', '{\"api_id\":\"1\"}', '2025-06-23 18:50:06'),
('9fb69bca56c7570e60461c15b6', '{\"api_id\":\"1\"}', '2025-06-23 18:50:05'),
('a40428f734a56279fbcc5e22ad', '[]', '2025-06-23 16:46:38'),
('aa4c3792a010675fd07ca02587', '{\"api_id\":\"1\"}', '2025-06-23 17:26:31'),
('adc414dec87d96a8f1f2b33c6b', '[]', '2025-06-23 17:25:30'),
('bef2e4a3035872079452d108a6', '{\"api_id\":\"1\"}', '2025-06-23 17:35:46'),
('c58c90afb692e887d1f2cf3f69', '[]', '2025-06-23 17:11:12'),
('c62ef6c3197ab2e4c69288ed98', '[]', '2025-06-23 17:20:51'),
('d07c03a5965390e33b11bd4cb6', '[]', '2025-06-23 17:42:15'),
('d39f68c400f78a94dc4c4753ed', '[]', '2025-06-23 21:10:03'),
('d9d44d1687f5d9d85ff9d08c71', '[]', '2025-06-23 18:09:32'),
('e05c3d20b64808397b06f7a0e4', '{\"api_id\":\"1\"}', '2025-06-23 17:42:20'),
('e99a5426b32029e90b0709ab5d', '[]', '2025-06-23 17:16:19'),
('ef2171c4783e7f4229a8742a32', '{\"api_id\":\"1\"}', '2025-06-23 16:55:26');
...
(203, 0, 'config', 'config_encryption', '', 0),
...
(284, 0, 'module_retailcrm', 'module_retailcrm_collector_active', '0', 0),
(283, 0, 'module_retailcrm', 'module_retailcrm_missing_status', 'new', 0),
(282, 0, 'module_retailcrm', 'module_retailcrm_default_shipping', 'flat.flat', 0),
(281, 0, 'module_retailcrm', 'module_retailcrm_default_payment', 'cod', 0),
(280, 0, 'module_retailcrm', 'module_retailcrm_payment', '{\"cod\":\"cash\",\"free_checkout\":\"cash\"}', 1),
(279, 0, 'module_retailcrm', 'module_retailcrm_delivery', '{\"flat.flat\":\"courier\"}', 1),
(276, 0, 'module_retailcrm', 'module_retailcrm_stock_upload', '0', 0),
(277, 0, 'module_retailcrm', 'module_retailcrm_label_discount', 'Discount in RetailCRM', 0),
(278, 0, 'module_retailcrm', 'module_retailcrm_sum_payment', '0', 0),
(293, 0, 'retailcrm_history', 'retailcrm_history_customers', '439', 0),
(222, 0, 'retailcrm_setting', 'retailcrm_setting_active_in_crm', '1', 0),
(223, 0, 'retailcrm_setting', 'retailcrm_setting_client_id', '6859700b40b9a', 0),
(224, 0, 'retailcrm_setting', 'retailcrm_setting_url', 'https://molchanovvdm.retailcrm.ru', 0),
(225, 0, 'retailcrm_setting', 'retailcrm_setting_key', 'rdCGi8Eg449yhMUZT4jd0IBttsyD08bn', 0),
(285, 0, 'module_retailcrm', 'module_retailcrm_collector', '{\"site_key\":\"\",\"form_capture\":\"0\",\"period\":\"\",\"label_promo\":\"\",\"label_send\":\"\",\"custom_form\":\"0\",\"custom\":{\"name\":\"    \",\"email\":\"    \",\"phone\":\"    \"}}', 1),
(275, 0, 'module_retailcrm', 'module_retailcrm_summ_around', '0', 0),
(274, 0, 'module_retailcrm', 'module_retailcrm_order_number', '0', 0),
(273, 0, 'module_retailcrm', 'module_retailcrm_special_1', '', 0),
(272, 0, 'module_retailcrm', 'module_retailcrm_status_changes', '1', 0),
(271, 0, 'module_retailcrm', 'module_retailcrm_lenght', '1', 0),
(270, 0, 'module_retailcrm', 'module_retailcrm_currency', 'USD', 0),
(269, 0, 'module_retailcrm', 'module_retailcrm_icml_service_enabled', '1', 0),
(268, 0, 'module_retailcrm', 'module_retailcrm_country', '[\"222\"]', 1),
(266, 0, 'module_retailcrm', 'module_retailcrm_apikey', 'rdCGi8Eg449yhMUZT4jd0IBttsyD08bn', 0),
(267, 0, 'module_retailcrm', 'module_retailcrm_corporate_enabled', '0', 0),
(265, 0, 'module_retailcrm', 'module_retailcrm_url', 'https://molchanovvdm.retailcrm.ru', 0),
(264, 0, 'module_retailcrm', 'module_retailcrm_status', '{\"7\":\"new\",\"9\":\"new\",\"13\":\"new\",\"5\":\"new\",\"8\":\"new\",\"14\":\"new\",\"10\":\"new\",\"1\":\"new\",\"15\":\"new\",\"2\":\"new\",\"11\":\"new\",\"12\":\"new\",\"3\":\"new\",\"16\":\"new\"}', 1),
(292, 0, 'retailcrm_history', 'retailcrm_history_orders', '412', 0),
(286, 0, 'module_retailcrm', 'module_retailcrm_online_consultant_code', '                                                                                                                                                                                                                                                                                                                                        ', 0),
(287, 0, 'module_retailcrm', 'module_retailcrm_online_consultant_active', '0', 0),
(288, 0, 'module_retailcrm', 'module_retailcrm_custom_field_active', '1', 0),
(289, 0, 'module_retailcrm', 'module_retailcrm_custom_field', '{\"c_1\":\"countchild\",\"c_2\":\"commentoperator\"}', 1);

-- --------------------------------------------------------

--
-- Структура таблицы `shipping_courier`
--
...
--
-- Дамп данных таблицы `shipping_courier`
--
...
(1, 1, 'admin', '8ce98e6ffcf672172236d481a0c2298a557f8d37', 'F8Nk41kFh', 'John', 'Doe', 'admin@gmail.com', '', '', '127.0.0.1', 1, '2025-06-23 17:56:46');
...
--
-- Индексы таблицы `customer_affiliate`
--
ALTER TABLE `customer_affiliate`
  ADD PRIMARY KEY (`customer_id`);

--
-- Индексы таблицы `customer_approval`
--
...
--
-- Индексы таблицы `customer_search`
--
...
--
-- Индексы таблицы `customer_wishlist`
--
...
--
-- Индексы таблицы `extension_install`
--
ALTER TABLE `extension_install`
  ADD PRIMARY KEY (`extension_install_id`);

--
-- Индексы таблицы `extension_path`
--
...
--
-- Индексы таблицы `googleshopping_category`
--
ALTER TABLE `googleshopping_category`
  ADD PRIMARY KEY (`google_product_category`,`store_id`),
  ADD KEY `category_id_store_id` (`category_id`,`store_id`);

--
-- Индексы таблицы `googleshopping_product`
--
ALTER TABLE `googleshopping_product`
  ADD PRIMARY KEY (`product_advertise_google_id`),
  ADD UNIQUE KEY `product_id_store_id` (`product_id`,`store_id`);

--
-- Индексы таблицы `googleshopping_product_status`
--
ALTER TABLE `googleshopping_product_status`
  ADD PRIMARY KEY (`product_id`,`store_id`,`product_variation_id`);

--
-- Индексы таблицы `googleshopping_product_target`
--
ALTER TABLE `googleshopping_product_target`
  ADD PRIMARY KEY (`product_id`,`advertise_google_target_id`);

--
-- Индексы таблицы `googleshopping_target`
--
ALTER TABLE `googleshopping_target`
...
--
-- Индексы таблицы `order_shipment`
--
...
--
-- Индексы таблицы `recurring`
--
ALTER TABLE `recurring`
  ADD PRIMARY KEY (`recurring_id`);

--
-- Индексы таблицы `recurring_description`
--
...
--
-- Индексы таблицы `shipping_courier`
--
...
--
-- AUTO_INCREMENT для таблицы `api_ip`
--
ALTER TABLE `api_ip`
  MODIFY `api_ip_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `api_session`
--
ALTER TABLE `api_session`
...
--
-- AUTO_INCREMENT для таблицы `customer_approval`
--
ALTER TABLE `customer_approval`
...
--
-- AUTO_INCREMENT для таблицы `customer_search`
--
ALTER TABLE `customer_search`
...
--
-- AUTO_INCREMENT для таблицы `extension_install`
--
ALTER TABLE `extension_install`
  MODIFY `extension_install_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `extension_path`
--
ALTER TABLE `extension_path`
...
--
-- AUTO_INCREMENT для таблицы `googleshopping_product`
--
ALTER TABLE `googleshopping_product`
...
--
ALTER TABLE `order_history`
  MODIFY `order_history_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
-- AUTO_INCREMENT для таблицы `order_shipment`
--
ALTER TABLE `order_shipment`
...
--
ALTER TABLE `order_total`
  MODIFY `order_total_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
...
--
-- AUTO_INCREMENT для таблицы `recurring`
--
ALTER TABLE `recurring`
...
--
-- AUTO_INCREMENT для таблицы `seo_url`
--
ALTER TABLE `seo_url`
