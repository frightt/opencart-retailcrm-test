...
class ModelCheckoutOrder extends Model {
	public function addOrder($data) {
        ...
        if (isset($this->session->data['custom_field']['delivery_datetime'])) {
            $data['custom_field']['delivery_datetime'] = $this->session->data['custom_field']['delivery_datetime'];
        } else {
            $data['custom_field']['delivery_datetime'] = null;
        }


        if (isset($this->session->data['custom_field']['need_call'])) {
            $data['custom_field']['need_call'] = (int)$this->session->data['custom_field']['need_call'];
        } else {
            $data['custom_field']['need_call'] = 0;
        }
