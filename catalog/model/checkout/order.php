...
class ModelCheckoutOrder extends Model {
	public function addOrder($data) {
        ...
        if (isset($this->session->data['delivery_datetime'])) {
            $data['custom_field']['delivery_datetime'] = $this->session->data['delivery_datetime'];
        }

        if (isset($this->session->data['need_call'])) {
            $data['custom_field']['need_call'] = (int)$this->session->data['need_call'];
        }
